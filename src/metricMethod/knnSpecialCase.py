...
# Имеем матрицу значений x 1372 строк и 2 столбца для классификации по KNN частного случая
# Имеем массив значений y в 1372 элемента для классификации по KNN частного случая
dataX = dataset[:, :-3]
dataY = dataset[:, 4]
...
# Определяем модель классификатора KNN частного случая, где сосед K равен 1
...
"""
Крутил разные параметры. На текущий момент точность 0.9563106796116505
